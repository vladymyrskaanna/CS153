...
export function Lamp({ children, className }: { children?: ReactNode; className?: string }) {
  return (
    <div className={cn("relative flex flex-col items-center justify-center isolate z-0 overflow-hidden w-full", className)}>
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          style={{
            backgroundImage: `conic-gradient(var(--conic-position, from 70deg at center top), hsl(var(--primary)), transparent, transparent)`,
          }}
        ...
        <motion.div
          ...
          transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
          style={{
            backgroundImage: `conic-gradient(var(--conic-position, from 290deg at center top), transparent, transparent, hsl(var(--primary)))`,
          }}
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-primary/30 opacity-50 blur-3xl" />
        <motion.div
          initial={{ width: "8rem" }}
